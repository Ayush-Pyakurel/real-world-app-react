    ...
    <main className={styleSettings.container}>
      ...
      >
        <input
          ...
          value={location.state ? location.state.image : formik.values.image}
        ...
        <input
          ...
          onChange={formik.handleChange}
          value={location.state ? location.state.username : formik.values.username}
        ...
        <textarea
          ...
          onBlur={formik.handleBlur}
          onChange={formik.handleChange}
          value={location.state ? location.state.bio : formik.values.bio}
        ...
        <input
          ...
          onBlur={formik.handleBlur}
          onChange={formik.handleChange}
          value={location.state ? location.state.email : formik.values.email}
          placeholder="Email"
        />
        <div className={styleSettings.errors}>
